...
![Sprachauswahl](./pic/language.png 'Sprachauswahl')

Anschließend erscheint die Begrüßungsseite:
![Begrüßungsseite](./pic/welcome.png 'Begrüßungsseite')

Nach einem Klick auf "Weiter" erscheint die Lizenzseite:
![Lizenzseite](./pic/license.png 'Lizenzseite')
...
![Installationsordner](./pic/folder.png 'Installationsordner')
...
![Überprüfungen](./pic/check.png 'Überprüfungen')
Dies kann einen Moment dauern. Im Anschluss erscheint automatisch das Ergebnis der Überprüfung:
![Überprüfungsergebnis](./pic/checkresult.png 'Überprüfungsergebnis')
...
![Optionen](./pic/options.png 'Optionen')
...
3. Der ioBroker Fixer kann nicht ausgewählt werden
   ...
   ![Optionen](./pic/summary.png 'Optionen')
   Mit einem Klick auf "Installieren" wird jetzt die eigentliche Installation gestartet:
   ![Optionen](./pic/downloadnode.png 'Optionen')
   ![Optionen](./pic/installnode.png 'Optionen')
   ![Optionen](./pic/installiobroker.png 'Optionen')
   ![Optionen](./pic/finish.png 'Optionen')
